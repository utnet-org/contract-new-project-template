...
## use master-account-id.json.sample
...
unc account view-account-summary 7a17c8371a5a511fc92bc61e2b4c068e7546a3cd5d6c0bbdef1b8132c8b30376 network-config testnet now
